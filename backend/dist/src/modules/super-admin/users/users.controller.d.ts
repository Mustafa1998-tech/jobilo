...
export declare class AdminUsersController {
    ...
    listUsers(search?: string, role?: string, status?: string, verified?: string, dateFrom?: string, dateTo?: string, sortBy?: string, sortOrder?: string, page?: number, pageSize?: number): Promise<{
        data: {
            freelancerProfile: {
                firstName: string;
                lastName: string;
